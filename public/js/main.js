(function ($) {
    ...
    ================================================*/
    function autoHeight() {
        const why_choose_img = $('.apps-craft-why-chose-img'),
    ...
    function center(number) {
        const sync2 = $("#apps-craft-testimonial-thumb");
    ...
    $(document).ready(function () {
        ...
        /*===============================================
              5. Parallax Init
          ================================================*/
        const animation = $('#apps_craft_animation');
        const animation2 = $('#apps_craft_animation-2');
        ...
        /*===============================================
            6. Apps Craft Top Menu Offset
        ================================================*/
        const links = $('.apps-craft-menu ul li a, .apps-craft-menu-item ul li a, .apps-craft-logo a');
        if (links.length > 0) {
        ...
        /*===============================================
            7. Apps Craft Footer Menu Offset
        ================================================*/
        const menu = $('.apps-craft-footer-menu');
        if (menu.length > 0) {
            menu.on('click', 'a', function (e) {
                const href = $(this).attr("href"),
                    offsetTop = href === "#" ? 0 : $(href.replace(/^index.html/, '')).offset().top - 0;
        ...
        /*===============================================
            8. Apps Craft Sync Slider
        ================================================*/
        const sync1 = $("#apps-craft-commentor-slider");
        ...
        /*===============================================
              9. Apps Craft Video pop UP
          ================================================*/
        const popupVideo = $('.apps-craft-popup-video');
        ...
        /*===============================================
             10. Apps Craft Video Background
          ================================================*/
        const bgSection = $('.apps-craft-video-bg-section');
        if (bgSection.length > 0) {
            ...
            bgSection.tubular(options);
        }

        /*===============================================
             11. Apps Craft Welcome Slider
          ================================================*/
        const owl1 = $('#apps-craft-welcome-slider');
        if (owl1.length > 0) {
            owl1.owlCarousel({
                slideSpeed: 300,
                paginationSpeed: 400,
        ...
        /*===============================================
             12. Apps Craft Accordion
          ================================================*/
        const title = $('.apps-craft-accordion .panel-title');
        if (title.length > 0) {
        ...
        const apps_craft_form = $('#apps-craft-form');

        if (apps_craft_form.length > 0) {

            const apps_craft_contact_btn = $('#apps-craft-input-send');
            ...
            apps_craft_form.on('submit', function (e) {
                ...
                if (apps_craft_error === false) {
                    ...
                    axios.post('/send_email', {
                        'email': apps_craft_input_email.val(),
                        'message': apps_craft_input_message.val(),
                        'lang': window.$czater.language
                    }).then(function (response) {
                        // console.log(response);
                        apps_craft_contact_btn.after('<div class="apps-craft-success-message">' + 'Your message was send' + '</div>').hide().fadeIn();
                        ...
                        apps_craft_input_email.before('<div class="apps_craft_error">Problem with processing data.</div>').hide().fadeIn();
                        apps_craft_input_email.addClass('apps_craft_input_error');
        ...
        if (mcForm.length > 0) {
            mcForm.each(function () {
                ...
                const formThis = $(this).ajaxChimp({
                    url: 'https://autodating.us19.list-manage.com/subscribe/post?u=84e3eac6c4b8b578c055a4f6a&amp;id=3e5f9bf629',
        ...
        /*--------------------------------------------------------------
          20. RIPPLES CANVAS
        --------------------------------------------------------------*/
        const ripple = $('body.apps-craft-v8 #apps-craft-home');
        if (ripple.length > 0) {
            ripple.ripples({
                resolution: 512,
                dropRadius: 10, //px
...
// $('.apps-craft-humberger-menu').on('click', function() {
        const craftMenu = $('.apps-craft-menu');
        $('#apps-craft-main-menu-icon').on('click', function (e) {
            console.log("H Menu", e);
            if (craftMenu.hasClass('active')) {
                craftMenu.removeClass('active');
            } else {
                craftMenu.addClass('active');
            }
        });

        $('.apps-craft-menu-item ul li a, .apps-craft-logo a').on('click', function () {
            if (craftMenu.hasClass('active')) {
                craftMenu.removeClass('active');
            }
        });
...
// Version 18 Apps Screen
    ...
    if ($('#carousel').length > 0) {
        ...
        const init = function () {
            ...
            const carousel = new Carousel3D(document.getElementById('carousel')),
                navButtons = document.querySelectorAll('#navigation button'),

                onNavButtonClick = function (event) {
                    const increment = parseInt(event.target.getAttribute('data-increment'));
